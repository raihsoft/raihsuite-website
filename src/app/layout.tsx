            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 text-white/70">
              <div className="space-y-4 text-center sm:text-left flex flex-col items-center sm:items-start">
                ...
                <div className="flex items-center gap-4 pt-2">
                  <a
                    href="https://www.linkedin.com/company/raihsuite"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white/50 hover:text-white transition-colors"
                    aria-label="Raihsuite LinkedIn"
                  >
                  ...
                  <a
                    href="https://x.com/raihsuite"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white/50 hover:text-white transition-colors"
                    aria-label="Raihsuite X"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    href="https://www.instagram.com/raihsuite"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white/50 hover:text-white transition-colors"
                    aria-label="Raihsuite Instagram"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    href="https://www.youtube.com/@raihsuite"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white/50 hover:text-white transition-colors"
                    aria-label="Raihsuite YouTube"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
