...
const TextArea = forwardRef<HTMLTextAreaElement, Props>(({ label, error, hint, className, id, variant = 'light', ...rest }, ref) => {
  ...
  return (
    <div className="space-y-1.5">
      ...
      <textarea
        ...
        className={clsx(
          'w-full px-4 py-3 rounded-xl border outline-none transition-all duration-200 focus:ring-4 resize-none',
          styles.input,
